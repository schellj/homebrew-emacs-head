# coding: utf-8
class EmacsHeadNativeCompMacosAT28 < Formula
  desc "GNU Emacs text editor"
  homepage "https://www.gnu.org/software/emacs/"
  url "https://github.com/emacs-mirror/emacs.git", :branch => "feature/native-comp-macos-fixes"
  version "28.0.50"
  revision 1
  ...
  if build.with? "no-frame-refocus"
    patch do
      url EmacsHeadNativeCompMacosAT28.get_resource_url("patches/0001-No-frame-refocus-cocoa.patch")
  ...
  if build.with? "pdumper"
    patch do
      url EmacsHeadNativeCompMacosAT28.get_resource_url("patches/0003-Pdumper-size-increase.patch")
  ...
  patch do
    url EmacsHeadNativeCompMacosAT28.get_resource_url("patches/0005-System-appearance.patch")
